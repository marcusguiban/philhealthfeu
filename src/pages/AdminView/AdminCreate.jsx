        ...
        <Box component="form" onSubmit={handleSubmit} >
          ...
          <Stack direction={"column"} spacing={8} align="center" sx={{pt:10}}>
              <Stack>
                ...
                <TextField helperText="Barangay" variant="standard" type="text" required  name="Barangay" onChange={handleChanged} value={admin.Barangay}/>
                ...
                <TextField helperText="Postal Code" variant="standard" type="text" name="Postalcode" onChange={handleChanged} value={admin.Postalcode}/>
                </Stack>
              </Stack>
